...
import static com.ethernom.helloworld.MyApplication.getCurrentDate;
...
public class BleReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        MyApplication.appendLog("BleReceiver OnReceive callback: " + getCurrentDate() + "\n");
        mContext = context;
    ...
    private static ScanFilter getScanFilter() {
        ...
        manData.put(19, (byte) 0x2B); //major
        manData.put(20, (byte) 0xAA); //minor
        manData.put(21, (byte) 0x65); //minor
    ...
    public static void startScan(Context context) {
        ...
        try {
            ...
            MyApplication.appendLog("Start scanning: " + getCurrentDate() + "\n");
    ...
    public static void stopScan() {
        ...
        if (mContext == null) {
            ...
            MyApplication.appendLog("Can't stop: mContext null: " + getCurrentDate() + "\n");
        ...
        if (mPendingIntent == null) {
            ...
            MyApplication.appendLog("Can't stop: mPendingIntent null: " + getCurrentDate() + "\n");
        ...
        try {
            ...
            MyApplication.appendLog("Stop scanning: " + getCurrentDate() + "\n");

        } catch (Exception e) {
            Log.e(TAG, "ERROR in stopScan() " + e.getMessage());
            MyApplication.appendLog("ERROR in stopScan() : " + getCurrentDate() + "\n");
