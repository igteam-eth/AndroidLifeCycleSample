...
public class TrackerSharePreference {
    ...
    public void setRinging(boolean isRing) {
        sharedPrefs.edit().putBoolean(SharedPreKeyType.RINGING.toString(), isRing).apply();
    }

    public boolean isRinging() {
        return sharedPrefs.getBoolean(SharedPreKeyType.RINGING.toString(), false);
    }
