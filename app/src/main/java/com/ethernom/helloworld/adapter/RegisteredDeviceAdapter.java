...
public class RegisteredDeviceAdapter extends RecyclerView.Adapter  {
    private ArrayList<BleClient> bleClient;
    private OnItemCallback callback ;
    public RegisteredDeviceAdapter(ArrayList<BleClient> bleClient, OnItemCallback callback) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.btle_registered_device_list_item, parent, false);
