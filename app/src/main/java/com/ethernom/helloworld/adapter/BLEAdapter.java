...
public class BLEAdapter implements GetAppKeyCallback, CheckUpdateCallback {
    ...
    public void H2CGetMENU() {
        ...
        InitWriteToCard(data, buffer -> {
            ...
            if (isUserRefuseUpdate) {
                ...
                if (Utils.haveNetworkConnection(_context)) {
                    ...
                    ((DiscoverDeviceActivity) _context).runOnUiThread(() ->
                            mBLEAdapterCallback.showMessageError("Please enable internet connection!")
                    );
                }
    ...
    public void H2CRequestSessionPIN() {
        ...
        Integer pin_len = SettingSharePreference.getConstant(_context).getPinLength();
    ...
    public void getSucceeded(String appKey) {
        generate_auth_rsp(challenge, appKey);
    }
